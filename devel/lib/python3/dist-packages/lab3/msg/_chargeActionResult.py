...
"""autogenerated by genpy from lab3/ChargeActionResult.msg. Do not edit."""
import codecs
import sys
...
class ChargeActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "lab3/ChargeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab3/ChargeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChargeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = lab3.msg.ChargeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lab3.msg.ChargeResult()
