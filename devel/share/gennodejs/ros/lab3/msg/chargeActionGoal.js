...
class ChargeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ChargeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChargeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ChargeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ChargeGoal()
    }
...
module.exports = ChargeActionGoal;
