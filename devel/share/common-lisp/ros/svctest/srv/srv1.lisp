...
(cl:defmethod cl:initialize-instance :after ((m <srv1-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv1-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svctest-srv:<srv1-request> is deprecated: use svctest-srv:srv1-request instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader svctest-srv:A-val is deprecated.  Use svctest-srv:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader svctest-srv:B-val is deprecated.  Use svctest-srv:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <srv1-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader svctest-srv:C-val is deprecated.  Use svctest-srv:C instead.")
  (C m))
...
(cl:defmethod cl:initialize-instance :after ((m <srv1-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srv1-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svctest-srv:<srv1-response> is deprecated: use svctest-srv:srv1-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <srv1-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader svctest-srv:sum-val is deprecated.  Use svctest-srv:sum instead.")
  (sum m))
