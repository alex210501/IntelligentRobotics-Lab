...
(cl:defmethod cl:initialize-instance :after ((m <msg1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab2-msg:<msg1> is deprecated: use lab2-msg:msg1 instead.")))
...
(cl:defmethod C-val ((m <msg1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab2-msg:C-val is deprecated.  Use lab2-msg:C instead.")
  (C m))
