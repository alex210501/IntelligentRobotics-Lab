...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testaction-msg:<FibonacciGoal> is deprecated: use testaction-msg:FibonacciGoal instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <FibonacciGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testaction-msg:order-val is deprecated.  Use testaction-msg:order instead.")
  (order m))
